...
Clabel = Label(calc,text="CALCULATOR",bg='white',font=("Times",30,'bold'))
...
calctext=Entry(calc,font=("Courier New",12,'bold'),textvar=textin,width=25,bd=5,bg='light yellow')
calctext.pack()
...
butequal=Button(calc,padx=14,pady=14,bd=4,bg='white',text="(",command=lambda:clickbut("("),font=("Courier New",16,'bold'))
butequal.place(x=10,y=380)

butequal=Button(calc,padx=14,pady=14,bd=4,bg='white',text=")",command=lambda:clickbut(")"),font=("Courier New",16,'bold'))
butequal.place(x=75,y=380)

butequal=Button(calc,padx=85,pady=14,bd=4,bg='white',command=equlbut,text="=",font=("Courier New",16,'bold'))
